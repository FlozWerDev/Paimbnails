...
/**
 * Deteccion de formato de imagen por magic bytes.
 * Reemplaza imgp::guessFormat() e imgp::formats::isGif()
 * sin dependencias externas — inline, zero-overhead.
 */
...
enum class ImageFormat {
    ...
    TIFF,
    MP4,
    APNG    // PNG con animacion (se detecta como PNG primero)
};

/**
 * Detecta el formato de imagen a partir de los magic bytes.
 * Solo necesita los primeros 12 bytes para detectar cualquier formato.
 */
...
/**
 * Verifica si los datos son un GIF (GIF87a o GIF89a).
 * Equivalente directo de imgp::formats::isGif().
 */
...
/**
 * Verifica si los datos son un PNG.
 */
...
/**
 * Verifica si los datos son un JPEG.
 */
...
/**
 * Verifica si los datos son WebP.
 */
...
/**
 * Verifica si los datos son MP4/MOV.
 */
