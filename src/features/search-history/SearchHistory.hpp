#pragma once
//
// SearchHistory.hpp — Modelo de datos + persistencia del historial de busqueda.
//
// Port autocontenido del mod "Search History" de hiimjasmine00 (MIT),
// adaptado a las convenciones de Paimbnails. Guarda las busquedas hechas en
// LevelSearchLayer para poder repetirlas. La UI vive en ui/SearchHistoryPopup
// y el hook que la alimenta en hooks/LevelSearchLayer.cpp.
//
