...
// Sprite-frame candidates per rating tier, tried in order so older GD installs still show an icon.
...
// Reset label children to white so text stays readable on the tinted background.
