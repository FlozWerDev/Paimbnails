...
// existente "MenuLoopManager" (que ya hace el hook de GameManager::playMenuMusic).
//
// No reimplementamos el override de FMOD — delegamos en MenuLoopManager
// porque su hook ya tiene la prioridad correcta. MenuMusicPlayer sólo
// le dice: "ahora el override debe ser este path".
//
// Tambien lleva un historial para prev/next y publica eventos de cambio
// de track para que el popup se refresque.
