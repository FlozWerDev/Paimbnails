#pragma once
//
// PaimonIconsConfigPopup.hpp - Garage gear popup for the Paimon Icons feature.
//
// Layout:
//   - Header strip: title, close button, "Reset to defaults" button.
//   - Tab strip:    General | Locked | Animations | Apply To | Per-Mode | Presets
//   - Body:         a single CCNode swapped per tab.
//
// All edits go through IconConfigStore::update() so the rest of the system
// reacts via IconConfigChangedEvent.
//
