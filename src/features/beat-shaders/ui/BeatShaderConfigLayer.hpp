// BeatShaderConfigLayer — Popup UI for Beat Shaders. The feature applies
// audio-reactive postprocess shaders to the existing background of each
// supported layer (image, video, GIF, default). This popup persists every
// change immediately via BeatShaderManager.
#pragma once
