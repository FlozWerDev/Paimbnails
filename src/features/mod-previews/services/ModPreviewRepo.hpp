...
// ModPreviewRepo — convierte la URL de fuente de un mod (github.com / codeberg.org)
// en la URL "raw" base desde donde se descargan las previews.
// Idea/diseño original: Mod-Previews de Alphalaneous (portado a Geode v5).
