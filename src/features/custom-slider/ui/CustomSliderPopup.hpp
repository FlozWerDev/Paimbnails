...
protected:
    ...
    // ── General tab (column-based rows) ──
    cocos2d::CCNode* m_generalColumn = nullptr;
    cocos2d::CCNode* m_rowEnable = nullptr;
    cocos2d::CCNode* m_rowMode = nullptr;
    cocos2d::CCNode* m_rowIconType = nullptr;     // visible only in Icon mode
    cocos2d::CCNode* m_rowImagePick = nullptr;    // visible only in Image / GIF mode
    cocos2d::CCNode* m_rowPlayerIcon = nullptr;   // icon mode only
    cocos2d::CCNode* m_rowPlayerColors = nullptr; // icon mode only
    cocos2d::CCNode* m_rowScale = nullptr;
    cocos2d::CCNode* m_rowContainer = nullptr;    // image / gif mode only
    cocos2d::CCNode* m_rowShape = nullptr;        // image + container on

    // General tab labels & controls
    ...
    cocos2d::CCNode* m_shapeGridNode = nullptr;       // grid host for shape buttons
    cocos2d::CCMenu* m_shapeGridMenu = nullptr;       // menu containing shape buttons
