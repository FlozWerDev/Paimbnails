...
// ─────────────────────────────────────────────────────────────
// matjson serialization for PaimonIconConfig and its sub-types.
// ─────────────────────────────────────────────────────────────

namespace {

// Tiny helpers - matjson requires a lot of boilerplate; this keeps it tidy.
...
// ─────────────────────────────────────────────────────────────
// IconConfigStore implementation
// ─────────────────────────────────────────────────────────────
...
bool IconConfigStore::saveCurrentAsPreset(std::string const& name) {
    ...
    // If a preset with the same name exists, overwrite it.
