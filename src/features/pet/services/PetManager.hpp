...
// PetConfig: all pet settings, serializable to JSON// Supported layer names for pet visibility
...
struct PetConfig {
    ...
    // Pet Icon States: separate sprite per state; falls back to selectedImage if empty.
