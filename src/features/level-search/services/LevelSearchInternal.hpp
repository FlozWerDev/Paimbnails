// LevelSearchInternal.hpp - cuerpo (namespace anonimo) extraido de
// hooks/LevelSearchLayer.cpp. Se incluye UNA sola vez desde ese hook,
// despues de sus includes y de LevelSearchHelpers.hpp. NO incluir en
// otro TU: es un fragmento dependiente del contexto del hook.

namespace {
    // (releaseSearchInputFocus + BoundedTouchMenu movidos a
    //  features/level-search/services/LevelSearchHelpers.*)
